...
try:
    df_login = load_data('xls/senhas_acesso.xlsx')
    df_dados = load_data('xls/Resultados_diagnosticas/xls/bd_dados.xlsx')
    df_ama = load_data('xls/Resultados_diagnosticas/xls/bd_ama.xlsx')  # Carrega a nova tabela de alfabetização

...
st.set_page_config(
    ...
    page_icon="Resultados_diagnósticas/img/diplomado.png",
    layout="wide",
    initial_sidebar_state="expanded",
)

# Adicionando o logotipo na barra lateral
logo_url = 'Resultados_diagnósticas/img/Logomarca da Secretaria de Educação 2021.png'
with st.sidebar:
...
try:
    df_login = load_data('Resultados_diagnósticas/xls/senhas_acesso.xlsx')
    df_dados = load_data('Resultados_diagnósticas/xls/bd_dados.xlsx')
